<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @if(\Illuminate\Support\Facades\Auth::user()->is_banned != true)
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-nav-link :href="route('allUsersRecipes')" :active="request()->routeIs('allUsersRecipes')">
                            {{ __('All recipes') }}
                        </x-nav-link>
                    </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        @if(\Illuminate\Support\Facades\Auth::user()->isBanned != true)
            ...
            <div class="pt-2 pb-3 space-y-1">
                <x-responsive-nav-link :href="route('allUsersRecipes')" :active="request()->routeIs('allUsersRecipes')">
                    {{ __('All recipes') }}
                </x-responsive-nav-link>
            </div>
            ...
            @if(\Illuminate\Support\Facades\Auth::user()->isAdmin == true)
                <div class="pt-2 pb-3 space-y-1">
                    <x-responsive-nav-link :href="route('allUsers')" :active="request()->routeIs('allUsers')">
                        {{ __('All users') }}
                    </x-responsive-nav-link>
                </div>
            @endif
